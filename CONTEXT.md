...
| Input Image (img2img) | A starting raster image the denoising loop begins from instead of pure noise; how much it is overwritten is governed by the Denoise Strength. The "blending through input images" path, distinct from ControlNet structural conditioning. |
