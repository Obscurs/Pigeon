...
namespace sbx
{
	// Shared UUIDs for the text-generation demo. The model ID matches the Sandbox ResourcesManifest
	// (Assets/Sandbox/TextGeneration); the target-text ID is caller-assigned (not in the manifest):
