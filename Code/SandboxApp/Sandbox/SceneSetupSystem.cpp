...
namespace
{
	...
	void CreateSprite(pg::CheckedRegistryAccessor& accessor, const sbx::SandboxConfigSingletonComponent& config)
	{
		...
		transform = glm::translate(transform, glm::vec3(-1.5f, -0.9f, 0.f));
		transform = glm::scale(transform, glm::vec3(0.6f, 0.6f, 1.f));
		sprite.m_Transform = transform;
