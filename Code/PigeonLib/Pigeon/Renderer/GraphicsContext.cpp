...
pig::U_Ptr<pig::GraphicsContext> pig::GraphicsContext::Create(const pig::WindowsWindow* window)
{
	...
	case pig::RendererAPI::API::DirectX11:  return std::make_unique<pig::Dx11Context>(static_cast<HWND>(window->GetNativeWindow()));
	}
